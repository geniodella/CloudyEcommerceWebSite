					...
					<td style="border-radius: 5px; background: transparent">
						<div id="content-body">
							<div class="subcolumn1-1" id="content-text">
								<img
									src="<s:property value="#imagePath"/>/Under-construction.png"><br>
								<h2>
									<s:text name="it.ecomweb.page.support.text1" />
								</h2>
								<p>
									<s:text name="it.ecomweb.page.support.text2" />
								</p>
								<p>
									<s:text name="it.ecomweb.page.support.text3" />
								</p>
							</div>
