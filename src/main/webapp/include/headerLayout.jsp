		...
		<td id="header-logo" style="margin-right: 30px;">
			...
			<div style="display: block;">
				...
				<div id="header-menu-box">
					...
					<br>
					<img height="60" width="60" style="margin-top: 16px"
				...
				<div id="header-menu-box">
					...
					<br>
					<img height="50" width="50" style="margin-top: 11px"
						class="rollover"
				...
				<div id="contact-form">
					...
					<br>
					<img height="67" width="90" style="margin-top: 31px"
						class="rollover"
