...
<script>
	...
	<div id="content-container">
		...
		<div id="content">
            ...
            1.1 Le presenti condizioni generali ("Condizioni Generali") si applicano alla fornitura di servizi per la creazione e gestione di un negozio e-commerce basato su una piattaforma Add2Cart (powered by Magento), come meglio indicati nel paragrafo 2 ("Servizi") offerti da Add2Cart S.r.l. ("Add2Cart") attraverso il sito web www.ecommerce.it ("Sito")
                      ...
                      hosting della piattaforma Add2Cart;
								  </li>
							<li style="list-style-image: initial;list-style-type: disc;color:black;text-align: left;font-weight:normal;font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 15px; line-height: 10px; margin-top: 20px;padding: 0 0px 0 14px;">
             registrazione di nomi a dominio per conto del Cliente;
                   ...
                   moduli e template aggiuntivi.
...
</br>4.2 Add2Cart si impegna a fornire la piattaforma entro e non oltre quarantotto ore dall'accettazione dell'ordine da parte di Add2Cart.
								 </p>
                 	...
                 	<h1 style="margin-top: 20px;color:#46565F;font-family:'Della Respira',serif;font-weight:bold;font-size: 24px; line-height: 25px; padding: 0 13px;text-align:left">
				              ...
				              <p style="color:black;text-align: left;font-weight:normal;font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 14px; line-height: 25px; margin-top: 15px;padding: 0 0px 0 13px;">
							5.1 Add2Cart registra nomi dominio a nome e per conto del Cliente, attraverso i Registrant eNom e MisterDomain. I nomi a dominio registrati da Add2Cart resteranno di propriet&agrave; del Cliente anche a seguito della disattivazione di un account Cliente.
</br>5.2 Con l'invio dell'ordine, il Cliente conferisce mandato ad Add2Cart a compiere tutte le attivit&agrave; necessarie ai fini della registrazione del nome a dominio indicato dal Cliente, inclusa la presa visione delle condizioni di servizio e dell'informativa privacy messe di volta in volta a disposizione sui siti web dei Registrant utilizzati per la registrazione.
								 </p>
                 	...
                 	<h1 style="margin-top: 20px;color:#46565F;font-family:'Della Respira',serif;font-weight:bold;font-size: 24px; line-height: 25px; padding: 0 13px;text-align:left">
				              ...
				              <p style="color:black;text-align: left;font-weight:normal;font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 14px; line-height: 25px; margin-top: 15px;padding: 0 0px 0 13px;">
						6.1 Il Cliente riconosce che il rinnovo dell'account Cliente o dei nomi a dominio &egrave; responsabilit&agrave; unica ed esclusiva del Cliente. Add2Cart non assume alcun obbligo in tal senso. Il Cliente esonera Add2Cart da ogni responsabilit&agrave; derivante dal mancato rinnovo per qualsivoglia motivo dell'account Cliente o del nome a dominio. Il Cliente riconosce che vi possono essere molte ragione per cui Add2Cart sia impossibilitato a rinnovare l'account Cliente o il nome a dominio, incluso ma non limitato all'incapacit&agrave; di Add2Cart s.r.l., per qualunque motivo, di addebitare i costi di rinnovo sulla carta di credito o account paypal Il Cliente riconosce che il suddetto account Cliente e/o nome a dominio, se non rinnovato per tempo, verr&agrave; automaticamente terminato dal Registrant su cui il servizio &egrave; attivo.
								 </p>
                 	...
                 	<h1 style="margin-top: 20px;color:#46565F;font-family:'Della Respira',serif;font-weight:bold;font-size: 24px; line-height: 25px; padding: 0 13px;text-align:left">
				              ...
				              <p style="color:black;text-align: left;font-weight:normal;font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 14px; line-height: 25px; margin-top: 15px;padding: 0 0px 0 13px;">
							8.1 Allo scopo di mantenere un'alta efficienza operativa, Add2Cart esegue regolarmente il backup dei dati sui propri server, ma non ha alcun obbligo o dovere nei confronti del Cliente di eseguire backup secondo tali modalit&agrave;. E' responsabilit&agrave; esclusiva del Cliente eseguire i backup dei dati e dei files ospitati sui server di Add2Cart.
</br>8.2 L'accesso ai dati della propria piattaforma ecommerce, fornita dal servizio Add2Cart, &egrave; garantito solo attraverso il pannello di controllo di backend (raggiungibile tramite www.nomesito.xx/admin) della piattaforma stessa. E' espressamente vietato l'utilizzo di qualsivoglia tool esterno per l'accesso ai propri dati, siano essi files che dati contenuti nel database. Add2Cart si riserva il diritto di procedere all'immediata sospensione della piattaforma in presenza di ogni tentativo di accesso non autorizzato veicolato attraverso mezzi che non siano il pannello di controllo della piattaforma. 
								 </p>
                 	...
                 	<h1 style="margin-top: 20px;color:#46565F;font-family:'Della Respira',serif;font-weight:bold;font-size: 24px; line-height: 25px; padding: 0 13px;text-align:left">
				             9. Diritti di propriet&agrave; intellettuale
				              ...
				              <p style="color:black;text-align: left;font-weight:normal;font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 14px; line-height: 25px; margin-top: 15px;padding: 0 0px 0 13px;">
						9.1 I Servizi si fondano sul software open source per l'ecommerce Magento con l'integrazione di moduli, codici e grafiche di propriet&agrave; di Add2Cart. L'uso dei Servizi non implica in alcun modo la concessione al Cliente di una licenza d'uso dei moduli, codici e grafiche di propriet&agrave; di Add2Cart. Add2Cart si riserva il diritto di autorizzare la riproduzione, permanente o temporanea, totale o parziale, dei propri moduli, codici e grafiche, con qualsiasi mezzo o in qualsiasi forma; la traduzione, l'adattamento, la trasformazione e ogni altra modificazione, qualsiasi forma di distribuzione al pubblico. Il Cliente non pu&ograve;, direttamente o indirettamente, modificare, decompilare o disassemblare il codice sorgente dei moduli di propriet&agrave; di Add2Cart.
</br>9.2 L'utilizzo dei Servizi non implica conferimento al Cliente di alcun diritto o interesse nei confronti dei marchi, dei prodotti, di qualsivoglia progetto, diritto di propriet&agrave; intellettuale o industriale, denominazione commerciale, insegna o slogan o di altro segno distintivo di Add2Cart. In particolare, il Cliente non potr&agrave;, in mancanza di espressa autorizzazione di Add2Cart, utilizzare denominazione, marchi o altri segni distintivi di Add2Cart per brochure, pubblicit&agrave; o altre forme di comunicazione aventi carattere promozionale, n&egrave; potr&agrave; fare riferimento al rapporto professionale con Add2Cart al fine di promuovere se stesso, i propri servizi o societ&agrave; ad esso in qualunque modo collegate, anche dopo la disattivazione di un account Cliente o successivamente al recesso.
								 </p>
                 	...
                 	<h1 style="margin-top: 20px;color:#46565F;font-family:'Della Respira',serif;font-weight:bold;font-size: 24px; line-height: 25px; padding: 0 13px;text-align:left">
				              ...
				              <p style="color:black;text-align: left;font-weight:normal;font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 14px; line-height: 25px; margin-top: 15px;padding: 0 0px 0 13px;">
							10.1 Il Cliente si impegna ad utilizzare i Servizi nel rispetto della normativa vigente ed &egrave; pienamente responsabile dei contenuti dei propri siti web. Il Cliente si impegna a farsi carico di tutti i rischi connessi all'utilizzo o mancato utilizzo dei Servizi, nonch&egrave; al contenuto dei propri siti web, e ad assumersi la piena responsabilit&agrave; dell'eventuale pregiudizio causato a terzi dall'utilizzo dei Servizi, o dal contenuto dei propri siti web, anche dopo la disattivazione di un account Cliente o successivamente al recesso del Cliente. Il Cliente si impegna pertanto a non ritenere Add2Cart responsabile in alcun modo di eventuali danni derivanti o causati dall'utilizzo dei Servizi o dal contenuto dei propri siti web, nei limiti consentiti dalla legge.
</br>10.2 In nessun caso e in nessuna circostanza Add2Cart potr&agrave; essere ritenuta responsabile per perdite di dati o di files dei Clienti ospitati sui propri server.
</br>10.3 Add2Cart non potr&agrave; essere ritenuta responsabile per l'uso dei domini prescelti dal Cliente ai fini dell'installazione di una piattaforma Add2Cart. Il Cliente si impegna a tenere indenne Add2Cart da qualunque pretesa di terzi in relazione a tali domini, anche dopo la disattivazione di un account Cliente o successivamente al recesso del Cliente.
</br>10.4 L'utilizzo di un account Cliente come uno spazio di storage online per l'archiviazione di file elettronici &egrave; vietato e comporta la disattivazione dell'account Cliente senza alcun preavviso. Add2Cart non ha l'obbligo di monitorare i contenuti immessi dal Cliente sulla piattaforma Add2Cart. Tuttavia, Add2Cart potr&agrave; rimuovere tali contenuti o vietare qualsiasi utilizzo dei Servizi che ritiene sia (o possa essere) in violazione delle Condizioni Generali o di diritti di propriet&agrave; intellettuale di terze parti.
</br>10.5 Add2Cart non ha alcun obbligo di intervento per la risoluzione di problemi segnalati dal cliente. La piattaforma viene fornita cosi' come e.I termini dell'assistenza tecnica sono approfonditi nella pagina Assistenza Tecnica 
								 </p>
                 	...
                 	<h1 style="margin-top: 20px;color:#46565F;font-family:'Della Respira',serif;font-weight:bold;font-size: 24px; line-height: 25px; padding: 0 13px;text-align:left">
				              ...
				              <p style="color:black;text-align: left;font-weight:normal;font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 14px; line-height: 25px; margin-top: 15px;padding: 0 0px 0 13px;">
							11.1 Add2Cart potr&agrave; procedere, a sua insindacabile discrezione, alla disattivazione di un account Cliente qualora ritenga che il medesimo violi diritti di terzi o sia in altro modo contrario alla legge, o qualora richiesto dalle autorit&agrave; competenti.
</br>11.2 Add2Cart potr&agrave; disattivare l'account Cliente anche nel caso in cui il Cliente non provveda al saldo delle ultime due o più fatture.
</br>11.3 Il Cliente potr&agrave; recedere dal contratto in qualunque momento secondo le seguenti modalit&agrave;:
</br>invio di una email a info@add2cart.com;
</br> invio di una comunicazione scritta all'indirizzo S.C. Add2Cart S.r.l., Strada Gheorghe Lazar Nr.1 Ap. 2 - Zip Code: 300078 - Timisoara - Romania;
</br> richiesta di disattivazione dell'account direttamente dalla sua area Cliente.
</br>11.4 In caso di recesso, il Cliente non ha diritto alla restituzione del prezzo corrisposto ad Add2Cart n&egrave; ad alcun rimborso.
</br>11.5 In caso di disattivazione di un account cliente o di recesso, Add2Cart potr&agrave; cancellare tutti i dati archiviati dei Clienti entro 30 giorni dalla data di disattivazione o recesso. In caso di disattivazione dell'account cliente per le ragioni indicate nel paragrafo 11.2 che precede, Add2Cart provveder&agrave; alla cancellazione immediata di tutti i dati del Cliente.
								 </p>
...
</br> files della piattaforma Magento community edition alla base della propria installazione Add2Cart.
</br> 12.2 Al Cliente non sar&agrave; in nessun caso consentita l'esportazione dei moduli Add2Cart contenuti nella cartella /app e delle sue sottocartelle. Qualora il cliente volesse cambiare le modalit&agrave; di utilizzo della piattaforma o comunque continuare ad usarla attraverso modalit&agrave; diverse da quelle normalmente incluse nei Servizi, potr&agrave; accordarsi con Add2Cart sul costo e le modalit&agrave; di cessione della stessa.
								 </p>
                 	...
                 	<h1 style="margin-top: 20px;color:#46565F;font-family:'Della Respira',serif;font-weight:bold;font-size: 24px; line-height: 25px; padding: 0 13px;text-align:left">
				              ...
				              <p style="color:black;text-align: left;font-weight:normal;font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 14px; line-height: 25px; margin-top: 15px;padding: 0 0px 0 13px;">
						13.1 Il Cliente utilizza i Servizi a proprio rischio. Add2Cart si impegna a fornire in modo continuativo i Servizi, senza, tuttavia, assumere alcun obbligo al riguardo. In particolare, Add2Cart non fornisce alcuna garanzia in merito alla funzionalit&agrave; del Sito, dei moduli, codici e grafiche di propriet&agrave; di Add2Cart e dei Servizi, o all'assenza di errori nel Sito.
								 </p>
                 	...
                 	<h1 style="margin-top: 20px;color:#46565F;font-family:'Della Respira',serif;font-weight:bold;font-size: 24px; line-height: 25px; padding: 0 13px;text-align:left">
				              ...
				              <p style="color:black;text-align: left;font-weight:normal;font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 14px; line-height: 25px; margin-top: 15px;padding: 0 0px 0 13px;">
							16.1 Per ulteriori informazioni ed assistenza sul Sito o sulle modalit&agrave; di acquisto dei Servizi on-line il Cliente pu&ograve; contattare Add2Cart al seguente indirizzo e-mail: info@add2cart.com, oppure scrivere al seguente indirizzo:
</br>S.C. Add2Cart S.r.l.
