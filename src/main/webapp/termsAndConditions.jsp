...
</br>10.4 L'utilizzo di un account Cliente come uno spazio di storage online per l'archiviazione di file elettronici &egrave; vietato e comporta la disattivazione dell'account Cliente senza alcun preavviso. CloudyEcommerce non ha l'obbligo di monitorare i contenuti immessi dal Cliente sulla piattaforma CloudyEcommerce. Tuttavia, CloudyEcommerce potr&agrave; rimuovere tali contenuti o vietare qualsiasi utilizzo dei Servizi che ritiene sia (o possa essere) in violazione delle Condizioni Generali o di diritti di propriet&agrave; intellettuale di terze parti.
</br>10.5 CloudyEcommerce non ha alcun obbligo di intervento per la risoluzione di problemi segnalati dal cliente. La piattaforma viene fornita cosi' come e.I termini dell'assistenza tecnica sono approfonditi nella pagina Assistenza Tecnica 
								 </p>
...
</br>11.2 CloudyEcommerce potr&agrave; disattivare l'account Cliente anche nel caso in cui il Cliente non provveda al saldo delle ultime due o più fatture.
