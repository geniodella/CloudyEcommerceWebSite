	...
	<%@ include file="/include/headerLayout.jsp" %>
		...
		<div id="content">
			<div id="content-header">
				<h1><s:text name="it.ecomweb.page.title.support"/></h1>
			</div>
			<div id="content-body">
					<div class="subcolumn1-1" id="content-text">
					<img src="<s:property value="#imagePath"/>/Under-construction.png"><br>
						<h2><s:text name="it.ecomweb.page.support.text1"/></h2>
						<p><s:text name="it.ecomweb.page.support.text2"/></p>
						<p><s:text name="it.ecomweb.page.support.text3"/></p>
					</div>
					
					<div class="subcolumn1-2" id="content-text">
						<h2><s:text name="it.ecomweb.page.support.text1"/></h2>
						<p><s:text name="it.ecomweb.page.support.text2"/></p>
						<p><s:text name="it.ecomweb.page.support.text3"/></p>
					</div>
					
					<div class="subcolumn2-2" id="content-text">
						<h2><s:text name="it.ecomweb.page.support.text1"/></h2>
						<p><s:text name="it.ecomweb.page.support.text2"/></p>
						<p><s:text name="it.ecomweb.page.support.text3"/></p>
					</div>
